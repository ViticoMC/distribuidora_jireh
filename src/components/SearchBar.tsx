    ...
    return (
        <div className="relative w-full max-w-[90vw]">
            <input
                ...
                className="w-full py-3 pl-12 md:pl-14 pr-4 rounded-xl border-2 border-gray-300 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base md:text-lg transition-all touch-none max-w-[90vw]1"
            />
